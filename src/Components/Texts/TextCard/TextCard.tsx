...
export default function TextCard(props: TextTitle){
    ...
    const { data: progress, isSuccess, isError } = useGetGroupProgessQuery({userId, groupId: id_group || props.id_group}) //Есть случаи при загрузке group_id === null? Хотя он и не продразумевается но обрабоат его надо
    return (
