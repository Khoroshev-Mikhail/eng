...
import { getFalseVariants, getLearningThunk, getTrueVariant } from '../../app/clientAPI/learningAPI'
import { getUser, getUserId } from '../../app/clientAPI/userAPI'
import { setVocabularyAndGetUpdatedVocabularyThunk } from '../../app/clientAPI/vocabularyAPI'
...
export default function English(props: any){
    ...
    const trueVariant = useAppSelector(getTrueVariant)
    const falseVariants = useAppSelector(getFalseVariants)
    ...
    return(
        <>  
            ...
            <div className="w-full sm:w-96 mx-auto bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                ...
                <div className="p-5">
                    <h5 className="mb-2 text-center text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{trueVariant.eng}</h5>
                    {falseVariants && falseVariants.map((el: Word, i: number) => {
                        return (
